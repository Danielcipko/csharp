...
namespace BANKA
{
    public class Program
    {
        ...
        private static List<Ucet> zoznamUctov = new List<Ucet>();

        // Premenna pre ulozenie ID prihlaseneho pouzivatela
        private static Ucet prihlasenyUcet = null;
        ...
        static void Main(string[] args)
        {
            ...
            zoznamUctov.Add(new Ucet(noveID++, "Jano Mrkvicka", "heslo123", 550.50M));
            zoznamUctov.Add(new Ucet(noveID++, "Maria Novakova", "tajne", 1200.00M));
        ...
        static void Prihlasenie()
        {
            ...
            Ucet ucet = zoznamUctov.FirstOrDefault(u => u.ID == idUctu);
        ...
        static void ZalozenieUctu()
        {
            ...
            Ucet novyUcet = new Ucet(noveID, meno, heslo, vklad);
        ...
        static void Prevod()
        {
            ...
            // Najdenie prijemcu
            Ucet prijemca = zoznamUctov.FirstOrDefault(u => u.ID == idPrijemcu);
