...
namespace nahodne_mena
{
    internal class Program
    {
         static void Main(string[] args)
         {
              ...
              string femaleFullName = GetRandomString(femaleFirstNames, r) + "" + GetRandomString(femaleSurnamesSk, r);

              string maleFullName = GetRandomString(maleFirstNames, r) + "" + GetRandomString(maleSurnamesSk, r);

              Console.WriteLine("Zenske meno: " + femaleFullName);
              Console.WriteLine("Muzske meno: " + maleFullName);
